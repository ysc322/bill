...
class AipOcr extends AipBase
{
    ...
    /**
     * 出租车票识别 custom api url
     * @var string
     */
    private $carUrl = 'https://aip.baidubce.com/rest/2.0/ocr/v1/taxi_receipt';

    /**
     * 定额发票识别 custom api url
     * @var string
     */
    private $invUrl = 'https://aip.baidubce.com/rest/2.0/ocr/v1/quota_invoice';

    /**
     * 通用机打发票 custom api url
     * @var string
     */
    private $tyjdUrl = 'https://aip.baidubce.com/rest/2.0/ocr/v1/invoice';

    /**
     * 火车票 custom api url
     * @var string
     */
    private $huocheUrl = 'https://aip.baidubce.com/rest/2.0/ocr/v1/train_ticket';

    /**
     * 行程单 custom api url
     * @var string
     */
    private $xcUrl = 'https://aip.baidubce.com/rest/2.0/ocr/v1/air_ticket';
     ...
     * @return array
     */
    public function car($image, $options = array())
    {
        ...
        return $this->request($this->carUrl, $data);
    }
     ...
     * @return array
     */
    public function inv($image, $options = array())
    {
        ...
        return $this->request($this->invUrl, $data);
    }
     ...
     * @return array
     */
    public function tyjd($image, $options = array())
    {
        ...
        return $this->request($this->tyjdUrl, $data);
    }
     ...
     * @return array
     */
    public function huoche($image, $options = array())
    {
        ...
        return $this->request($this->huocheUrl, $data);
    }
     ...
     * @return array
     */
    public function xc($image, $options = array())
    {
        ...
        return $this->request($this->xcUrl, $data);
    }
